...
/*
 * Backward-compat aliases for v1.5.5 kernel hooks that haven't been
 * ported to v2.0.0 yet.  Remove once all hooks are updated.
 */
#define TASK_STRUCT_NON_ROOT_USER_APP_PROC  0x1
#define INODE_STATE_SUS_PATH   BIT(24)
#define INODE_STATE_SUS_KSTAT  BIT(25)
#define INODE_STATE_SUS_MOUNT  BIT(26)
...
#define DEFAULT_SUS_MNT_ID_FOR_KSU_PROC DEFAULT_SUS_MNT_ID_FOR_KSU_PROC_UNSHARE
